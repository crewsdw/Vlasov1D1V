...
class Basis2D:
    def __init__(self, orders):
        ...
        # up0 = cp.tensordot(self.b1.up, cp.eye(orders[1]), axes=0)
        # up1 = cp.tensordot(cp.eye(orders[0]), self.b2.up, axes=0)
        # self.up = [up0, up1]
        #
        # xi0 = cp.tensordot(self.b1.xi, cp.eye(orders[1]), axes=0)
        # xi1 = cp.tensordot(cp.eye(orders[1]), self.b2.xi, axes=0)
        # self.xi = [xi0, xi1]
        # print(self.b1.xi)
        # quit()
        # print(self.xi[1])
        # quit()
        # print(self.up[0].shape)
        # print(self.xi[0].shape)
        # print(self.xi[1].shape)
        # quit()
